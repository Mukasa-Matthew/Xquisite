...
import { FaMobileAlt, FaHeadphones, FaTools, FaTabletAlt, FaStar, FaMapMarkerAlt, FaPhone, FaEnvelope, FaInstagram, FaSnapchatGhost, FaTiktok, FaArrowLeft, FaShoppingCart, FaHeart } from 'react-icons/fa';
